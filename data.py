...
# from controls.models import Category, LaptopModel, Manufacturer, Specification, Supplier
# from django.db.transaction import atomic
# @atomic
# //C:\Users\daica\Downloads\ECOMMERCE_LAPTOP-main\source\data.csv
# def load_data():
...
#                     'M?ng nh?': 'Mỏng nhẹ', '?? ho?, k? thu?t': 'Đồ họa - Kỹ thuật', 'V?n phï¿½ï¿': 'Văn phòng'}
#         for dataS in reader(csv_file):
#             # print(dataS[0])
#             data = dataS[0].split(',')
